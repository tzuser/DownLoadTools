...
module.exports = {
  ...
  keywordModel: mongoose.model('Keyword', keywordSchema),
  followModel: mongoose.model('Follow', followSchema),
  subscribeModel: mongoose.model('Subscribe', subscribeSchema),
  readModel: mongoose.model('ReadRecord', readRecord),
};
